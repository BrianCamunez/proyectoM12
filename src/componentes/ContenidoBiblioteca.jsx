            ...
            >
              ...
              <Box>
                ...
                <Typography fontSize={13} color="#b3b3b3">
                  Crea una playlist personalizada
                </Typography>
              </Box>
            </Box>
            ...
            {userRole === "artista" && (
              ...
              >
                ...
                <Box>
                  ...
                  <Typography fontSize={13} color="#b3b3b3">
                    Sube una canción nueva a tu perfil
                  </Typography>
                </Box>
              </Box>
            )}
        ...
        >
          ...
          <Box mb={2}>
            ...
            <input
              ...
              onChange={(e) =>
                setSongData({ ...songData, nombre: e.target.value })
              }
              style={{
                width: "100%",
                padding: "10px",
          ...
          <Box mb={2}>
            ...
            <input
              ...
              accept="image/*"
              onChange={(e) =>
                setSongData({ ...songData, imagen: e.target.files[0] })
              }
              style={{ color: "white" }}
            />
          </Box>
          ...
          <Box mb={2}>
            ...
            <input
              ...
              accept="audio/mpeg"
              onChange={(e) =>
                setSongData({ ...songData, mp3: e.target.files[0] })
              }
              style={{ color: "white" }}
            />
          </Box>
            ...
            <button
              onClick={async () => {
                try {
                  ...
                  if (insertError)
                    throw new Error(
                      "Error al crear la canción: " + insertError.message
                    );
                  ...
                  // 5. Subir el MP3
                  const { data: mp3Upload, error: mp3Error } =
                    await supabase.storage
                      .from("canciones")
                  ...
                  if (mp3Error)
                    throw new Error(
                      "Error al subir el MP3: " + mp3Error.message
                    );

                  // 6. Obtener URLs públicas
                  const imageUrl = supabase.storage
                    .from("canciones")
                    .getPublicUrl(`${folder}/imagen.jpg`).data.publicUrl;
                  const mp3Url = supabase.storage
                    .from("canciones")
                    .getPublicUrl(`${folder}/cancion.mp3`).data.publicUrl;
                  ...
                  if (updateError)
                    throw new Error(
                      "Error al actualizar la canción: " + updateError.message
                    );
        ...
        >
          ...
          <Box mb={2}>
            ...
            <input
              ...
              onChange={(e) =>
                setPlaylistData({ ...playlistData, nombre: e.target.value })
              }
              style={{
                width: "100%",
                padding: "10px",
          ...
          <Box mb={2}>
            ...
            <input
              ...
              accept="image/*"
              onChange={(e) =>
                setPlaylistData({ ...playlistData, imagen: e.target.files[0] })
              }
              style={{ color: "white" }}
            />
          </Box>
            ...
            <button
              onClick={async () => {
                try {
                  ...
                  const { data: nuevaPlaylist, error: insertError } =
                    await supabase
                      .from("playlist")
                  ...
                  if (imagen) {
                    ...
                    const { data: imgUpload, error: imgError } =
                      await supabase.storage
                        .from("playlist")
